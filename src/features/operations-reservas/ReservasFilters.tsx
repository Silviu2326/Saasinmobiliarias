...
import type { ReservasFilters } from './types';

interface ReservasFiltersProps {
  filters: ReservasFilters;
  onChange: (filters: ReservasFilters) => void;
}

export default function ReservasFilters({ filters, onChange }: ReservasFiltersProps) {
  return (
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => onChange({ ...filters, vencimiento: e.target.value as any })}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            <option value="all">Todos</option>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => onChange({ ...filters, agenteId: e.target.value })}
