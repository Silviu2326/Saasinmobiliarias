...
export default function ReservasToolbar({
  selectedCount,
  onNew,
  onExport,
  onBulkSign,
          ...
          {selectedCount > 0 && (
            <div className="flex items-center space-x-2">
              ...
              <button
                onClick={onBulkSign}
                disabled={isSigning}
                className="inline-flex items-center px-3 py-1.5 border border-green-300 text-sm font-medium rounded-md text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-green-500 disabled:opacity-50"
              >
                {isSigning ? (
                  <>
              ...
              <button
                ...
                className="inline-flex items-center px-3 py-1.5 border border-yellow-300 text-sm font-medium rounded-md text-yellow-700 bg-yellow-50 hover:bg-yellow-100 focus:outline-none focus:ring-2 focus:ring-yellow-500 disabled:opacity-50"
              >
                {isCanceling ? (
                  <>
                    <svg className="animate-spin -ml-1 mr-1 h-4 w-4" fill="none" viewBox="0 0 24 24">
